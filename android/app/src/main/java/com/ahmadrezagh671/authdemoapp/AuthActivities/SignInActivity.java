...
public class SignInActivity extends AppCompatActivity {
    ...
    final static private String TAG = "SignInActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitBTN = findViewById(R.id.signInBTN);
    ...
    private void submit() {
        ...
        AuthRequest.sendSignInRequest(username, password, new AuthRequest.SignInCallback() {
            @Override
            public void onSuccess() {
                AuthRequest.sendAuthRequest(new AuthRequest.AuthCallback() {
                    ...
                    public void onUserBanned() {
                        startActivity(new Intent(SignInActivity.this,BanUserActivity.class));
                        finish();
                    }
                },SignInActivity.this);
            }
